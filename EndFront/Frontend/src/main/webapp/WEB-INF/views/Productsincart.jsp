...
<td></td>
<td></td>
<c:set var="grandTotal" value=""></c:set>

<td><a href="<c:url value='/cart/removecartitem/'></c:url>" class="label label-danger" pull-left >
...
<c:if test="${ !empty(cartItems) }">
<a href="shippingaddressform" class="btn btn-success pull-right">
